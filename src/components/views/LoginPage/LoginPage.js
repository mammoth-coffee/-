                    ...
                    <div id={style.socialLogin}>
                        <a href="www.naver.com">
                            <span className={style.logoBnt}>
                                <img src="img/LoginImages/naverBtn.png" width='65px' height='65px' alt="네이버" />
                            </span>
                        </a>
                        <a href="www.naver.com">
                            <span className={style.logoBnt}>
                                <img src="img/LoginImages/googleBtn.png" width='65px' height='65px' alt="구글" />
                            </span>
                        </a>
                
                        <a href="www.naver.com">
                            <span className={style.logoBnt}>
                                <img src="img/LoginImages/facebookBtn.png" width='65px' height='65px' alt="페이스북" />
                            </span>
                        </a>
                    </div>
                </div>
